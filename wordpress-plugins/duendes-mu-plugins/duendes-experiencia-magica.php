    ...
    <div class="prod-grid">
        ...
        <div class="prod-details">
            ...
            <div class="prod-trust">
                ...
                <span class="prod-trust-item"><?php echo duendes_icon('star', 20); ?> Ser unico</span>
                <span class="prod-trust-item"><?php echo duendes_icon('scroll', 20); ?> Estudio de Canalización</span>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="prod-spec-box" style="padding: 30px;">
            ...
            <div class="prod-spec-content" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div style="text-align: center; padding: 15px 25px; background: #f8f8f8; border-radius: 8px;">
                    <div style="font-family: 'Cinzel', serif; font-size: 28px; color: <?php echo $color; ?>; font-weight: 500;"><?php echo $altura ? esc_html($altura) : '~25'; ?></div>
                    <div style="font-size: 10px; letter-spacing: 2px; color: #666; margin-top: 5px;">CENTÍMETROS</div>
                </div>
                <div style="text-align: center; padding: 15px 25px; background: #f8f8f8; border-radius: 8px;">
...
<section class="prod-testimonios">
    <div class="prod-testimonios-inner">
        <p class="prod-section-label" style="color: <?php echo $color; ?>;"><?php echo duendes_ornament('star-small', $color); ?> TESTIMONIOS <?php echo duendes_ornament('star-small', $color); ?></p>
        <h2 class="prod-section-title" style="color: #fff;">Experiencias de Elegid<?php echo ($es_femenino ? 'a' : 'o'); ?>s que ya tienen sus Guardianes</h2>
