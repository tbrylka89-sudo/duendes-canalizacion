<?php
/*
Plugin Name: Test Guardian v13 - Magenta Neon
...
function duendes_test_guardian_v13_render() {
    ...
    ob_start();
?>
<!-- TEST GUARDIAN v13 - CON PERFILADO PSICOLOGICO -->
...
#tg-app::before {
    ...
    background-image:
        radial-gradient(2px 2px at 20% 30%, rgba(255, 0, 128, 0.3), transparent),
        radial-gradient(2px 2px at 80% 20%, rgba(255, 0, 128, 0.2), transparent),
        radial-gradient(2px 2px at 40% 70%, rgba(255, 0, 128, 0.3), transparent);
...
.tg-section-box:hover {
    border-color: rgba(255, 0, 128, 0.6) !important;
    box-shadow: 0 0 25px rgba(255, 0, 128, 0.2) !important;
}

.tg-section-box.tg-section-highlight {
...
.tg-section-text:last-child {
    margin-bottom: 0 !important;
}

.tg-section-text.tg-accent {
...
.tg-main-icon {
    ...
    box-shadow: 0 0 40px rgba(255, 0, 128, 0.5), 0 0 80px rgba(255, 0, 128, 0.3) !important;
    animation: glow 3s ease-in-out infinite !important;
}

@keyframes glow {
    0%, 100% { box-shadow: 0 0 40px rgba(255, 0, 128, 0.5), 0 0 80px rgba(255, 0, 128, 0.3); }
    50% { box-shadow: 0 0 60px rgba(255, 0, 128, 0.7), 0 0 100px rgba(255, 0, 128, 0.5); }
}
...
.tg-btn:hover {
    ...
    box-shadow: 0 0 50px rgba(255, 0, 128, 0.5) !important;
...
.tg-textarea:focus {
    outline: none !important;
    border-color: #FF0080 !important;
    box-shadow: 0 0 25px rgba(255, 0, 128, 0.15) !important;
}
...
.tg-progress-fill {
    ...
    background: linear-gradient(90deg, #FF0080, #00ffcc) !important;
    border-radius: 2px !important;
...
.tg-guardian-img {
    ...
    box-shadow: 0 0 30px rgba(255, 0, 128, 0.4) !important;
}
...
.tg-guardian-circle.main .tg-guardian-name { font-size: 20px !important; color: #FF0080 !important; }
...
.tg-highlight {
    ...
    font-size: 32px !important;
    display: inline-block !important;
    text-shadow: 0 0 40px rgba(255, 0, 128, 0.5) !important;
}
...
@media (max-width: 768px) {
    ...
    .tg-guardian-card.main .tg-guardian-img,
    .tg-guardian-card .tg-guardian-img {
...
@media (max-width: 400px) {
    .tg-title { font-size: 20px !important; }
    .tg-elegidos-text { font-size: 15px !important; }
    .tg-highlight { font-size: 22px !important; }
    .tg-btn {
        padding: 14px 25px !important;
        font-size: 12px !important;
    }
    .tg-option-text { font-size: 13px !important; }
    .tg-guardian-card.main .tg-guardian-img,
    .tg-guardian-card .tg-guardian-img {
        width: 80px !important;
        height: 80px !important;
...
<div class="tg-container">
    ...
    <div id="screen-elegidos" class="tg-screen active">
        <div class="tg-elegidos-sections">
            <div class="tg-section-box">
                <p class="tg-section-text">Existen personas que fueron llamadas.</p>
                <p class="tg-section-text">No por su nombre, sino por algo más profundo.</p>
            </div>
            <div class="tg-section-box tg-section-highlight">
                <p class="tg-section-text">Los llaman</p>
                <h2 class="tg-highlight">Los Elegidos</h2>
            </div>
            <div class="tg-section-box">
                <p class="tg-section-text">Son quienes cuidan de un guardián.</p>
                <p class="tg-section-text tg-accent">O quizás... son cuidados por él.</p>
            </div>
        </div>
    ...
    <div id="screen-music" class="tg-screen">
        <div class="tg-music-activator" onclick="TG11.activateFrequency()">
            ...
            <div class="tg-frequency-icon">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#FF0080" stroke-width="2">
    ...
    <div class="tg-music-toggle" id="music-toggle" onclick="TG11.toggleMusic()">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF0080" stroke-width="2">
            <path d="M9 18V5l12-2v13"></path>
            <circle cx="6" cy="18" r="3"></circle>
            <circle cx="18" cy="16" r="3"></circle>
        </svg>
...
(function() {
    ...
    var PRODUCTS_FALLBACK = [
        { nombre: 'Finnegan', color1: '#FF0080', color2: '#990050', inicial: 'F', url: 'https://duendesdeluruguay.com/shop/' },
    ...
    TG11.renderResult = function(apiData, perfil) {
        ...
        function renderOrb(g, size, isMain) {
            if (g.imagen) {
                return '<img src="' + g.imagen + '" style="width:' + size + 'px;height:' + size + 'px;border-radius:50%;object-fit:cover;border:3px solid #FF0080;" alt="' + g.nombre + '">';
            }
            var fs = isMain ? '48px' : '32px';
            return '<div style="width:' + size + 'px;height:' + size + 'px;background:linear-gradient(135deg,' + (g.color1||'#FF0080') + ',' + (g.color2||'#990050') + ');border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:' + fs + ';font-family:Cinzel Decorative,serif;color:#fff;">' + g.inicial + '</div>';
        }
