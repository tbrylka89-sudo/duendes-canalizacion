    ...
    <header class="dn-header">
        <div class="dn-header-inner">
            <nav class="dn-nav-group">
                ...
                <a href="<?php echo home_url('/descubri-que-duende-te-elige/'); ?>" class="dn-nav-item">
    ...
    <div class="dn-nosotros">
        ...
        <section class="dn-cta-section">
            ...
            <div class="dn-cta-buttons">
                <a href="<?php echo home_url('/descubri-que-duende-te-elige/'); ?>" class="dn-btn dn-btn-primary">
