...
export async function POST(request) {
  console.log('[WEBHOOK-WOO-DEPRECATED] Redirigiendo a webhook unificado...');
  ...
  try {
    ...
    console.log('[WEBHOOK-WOO-DEPRECATED] Respuesta del webhook unificado:', result.success);
    ...
    console.error('[WEBHOOK-WOO-DEPRECATED] Error:', error);
    return Response.json({
      success: false,
      error: error.message,
      _nota: 'Este endpoint está deprecated. Usar /api/webhooks/woocommerce'
