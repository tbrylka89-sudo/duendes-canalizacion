...
export const FAQS = [
  ...
  { p: '¿Qué es el certificado de canalización?', r: 'Es el documento digital oficial que acompaña a cada guardián. Incluye su nombre, la fecha en que fue canalizado y un mensaje único del guardián para vos. Es 100% digital: lo podés ver y descargar desde la sección Mi Magia de tu cuenta, disponible 24 horas después de tu compra.' },
  ...
  { p: '¿Qué incluye la compra de un guardián?', r: 'Tu guardián llega con todo: la figura física articulada, acceso al certificado de canalización digital con su mensaje único desde Mi Magia, acceso al portal donde gestionás tu colección, y runas de bienvenida para empezar a explorar las experiencias mágicas.' },
