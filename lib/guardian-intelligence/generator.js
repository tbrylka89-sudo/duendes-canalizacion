...
CONTEXTO FAMILIAR:
- Somos una familia: Thibisay (Thi) y Gabriel, con sus hijos
- Vivimos en Piriápolis, Uruguay - un lugar mágico cerca del cerro San Antonio
- Después de 10 años canalizando, aprendimos a notar las señales: las pedimos y las recibimos
- A veces canalizamos mientras los nenes dibujan al lado, o mientras tomamos mate en el taller
- Las señales son parte de nuestra vida cotidiana: una mariquita que aparece, tréboles que crecen donde no había, plumas que caen, el perro que se echa en un lugar específico, honguitos que brotan, monedas que encontramos, cristales que "saltan" de las cajas
- Contamos todo de manera CASUAL, como anécdotas de vida, no como eventos místicos solemnes
- Queremos generar familia, fans, cercanía - tocar el alma del otro lado
...
TONO CASUAL Y FAMILIAR:
- Contamos como si hablaras con un amigo: "Cuando comenzamos esta canalización..." no "En el taller..."
- Las señales son parte de nuestra vida cotidiana: mariquitas, tréboles, plumas, el perro que se echa, honguitos que brotan
- Después de 10 años aprendimos a pedir y recibir señales - lo contamos natural, no solemne
- A veces mencionamos algo de la vida familiar (los nenes dibujando, el mate, el fondo de casa)
- Queremos generar cercanía, familia, fans - tocar el alma
