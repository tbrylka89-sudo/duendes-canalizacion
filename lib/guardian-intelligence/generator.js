...
📌 VARIEDAD EN ENFOQUES - MUY IMPORTANTE:
No todas las historias deben empezar desde el dolor. VARIÁ entre estos enfoques:

1. **DESDE EL GUARDIÁN** (recomendado para variar):
   - Presentar quién es ${nombre}, qué trae, para qué vino
   - Su energía, su esencia, lo que transmitió al canalizarlo
   - Ej: "${nombre} llegó con una energía clara: viene a..."

2. **DESDE UNA BÚSQUEDA/SITUACIÓN** (no dramático):
   - Una etapa de vida, un momento de cambio, una decisión
   - Ej: "Si estás en un momento de...", "Para quienes buscan..."

3. **DESDE EL DOLOR** (usar con moderación, no siempre):
   - Solo cuando sea genuinamente relevante
   - No todas las historias deben ser dramáticas

ORDEN SUGERIDO PARA ESTA HISTORIA:
- PRIMERO: Presentar al guardián (quién es, qué trae)
- DESPUÉS: Conectar con la persona (para quién es, qué situación acompaña)
- AL FINAL: El mensaje personal del guardián

❌ SIEMPRE PROHIBIDO (frases genéricas de IA):
- "En lo profundo del bosque..."
- "Las brumas del..." / "Desde tiempos inmemoriales..."
- "El velo entre mundos..." / "En un mundo donde..."
...
⭐ EL MENSAJE DEL GUARDIÁN - ES EL GANCHO:
   - Es lo que hace que alguien diga "ESTE es para mí"
   - Habla DIRECTO a un tipo de persona específica (no genérico)
   - Cada guardián tiene un gancho DIFERENTE - no repetir fórmulas
   - En primera persona, entre <em></em>
   - NO explicar que es un mensaje - solo ponerlo, se entiende solo
   - Ejemplos de ganchos: "Sé que estás cansada de dar tanto sin recibir nada", "Vengo por los que aprendieron a callarse para no molestar", "Busco a quien perdió la fe en sí mismo"
