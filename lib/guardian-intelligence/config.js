...
export const HOOKS_APERTURA = {
  proteccion: [
    ...
    'El cansancio de cuidar a todos menos a vos misma se siente en los huesos.',
    'Algunas personas nacieron siendo escudo de otros sin que nadie les preguntara.',
    'Cuando fue la última vez que alguien cuidó de vos como vos cuidás de todos?',
    'No todos los guerreros usan armadura. Algunos usan sonrisas.',
    'Hay batallas que se pelean en silencio, sin testigos.',
    'El peso de ser fuerte para otros es el secreto mejor guardado.',
    'Ser el refugio de todos tiene un costo que nadie ve.'
  ],
  abundancia: [
    'La prosperidad no es solo dinero - es sentir que merecés recibir.',
    'Hay quienes trabajan el doble y reciben la mitad.',
    'El problema no es cuánto ganás, es cuánto te permitís quedarte.',
    'Algunos aprendieron que pedir es de débiles. Y ahí empezó el bloqueo.',
    'La abundancia llega cuando dejás de sentirte culpable por desearla.',
    'No es falta de esfuerzo, es un bloqueo que no sabías que tenías.',
    'Merecés que las cosas buenas lleguen sin tanto sacrificio.',
    'El dinero tiene memoria. Sabe dónde lo reciben con culpa.',
    'Prosperidad es permitirte recibir sin disculparte.'
  ],
  amor: [
    'El amor propio no es egoísmo - es la base de todo lo demás.',
    'Hay corazones que dieron tanto que olvidaron cómo recibir.',
    'Buscamos afuera lo que no encontramos adentro. Ahí empieza el problema.',
    'El amor que das a otros es el que te negás a vos misma.',
    'Algunas heridas del corazón solo las ve quien las carga.',
    'No es que no merezcas amor. Es que olvidaste cómo dejarlo entrar.',
    'El corazón también necesita quien lo cuide.',
    'Diste tanto que te quedaste vacía. Y nadie lo notó.',
    'Amar a otros es fácil. Amarte a vos... eso es otro tema.'
  ],
  salud: [
    'El cuerpo habla. La pregunta es si estás escuchando.',
    'Hay dolores que no aparecen en ningún estudio médico.',
    'El cansancio que no se va con dormir tiene otro origen.',
    'Tu cuerpo está pidiendo algo que la mente no quiere escuchar.',
    'La sanación empieza cuando dejás de ignorar las señales.',
    'No todo se cura con pastillas. Algunas cosas necesitan otra medicina.',
    'El cuerpo guarda lo que la boca no dice.',
    'Hay agotamientos que vienen del alma, no del cuerpo.',
    'Sanar es también soltar lo que ya no te sirve.'
  ],
  sabiduria: [
    'Hay respuestas que ya tenés pero no te animás a escuchar.',
    'La claridad llega cuando dejás de buscarla tan fuerte.',
    'Sabés más de lo que creés. Solo te falta confiar.',
    'Las decisiones más importantes no se piensan, se sienten.',
    'A veces la sabiduría es simplemente callarse y observar.',
    'La intuición habla bajito. El ruido mental la tapa.',
    'Tenés la respuesta. Solo necesitás el silencio para escucharla.',
    'No es que no sepas qué hacer. Es que tenés miedo de hacerlo.',
    'La sabiduría no es saber todo, es saber qué ignorar.'
  ],
  sanacion: [
    'Algunas heridas necesitan más que tiempo.',
    'Sanar no es olvidar, es poder recordar sin que duela.',
    'El primer paso para curarte es admitir que estás rota.',
    'Hay cosas que no se superan, se transforman.',
    'La herida que no sanás se convierte en la historia que repetís.',
    'Curar a otros es más fácil que curarte a vos misma.',
    'No todo lo roto necesita arreglarse. Algunas cosas necesitan soltarse.',
    'Sanar duele. Pero menos que seguir cargando.',
    'Las cicatrices cuentan historias de batallas ganadas.'
  ]
};
...
export const PATRONES_APERTURA = {
  pregunta_cuantas: ['cuántas veces', '¿cuántas veces', 'cuantas veces', 'cuando fue la última vez'],
  hay_quienes: ['hay quienes', 'hay personas que', 'hay gente que', 'algunas personas', 'algunos'],
  reflexion: ['dicen que', 'cuentan que', 'se dice que'],
  temporal: ['desde siempre', 'todo comenzó', 'hace tiempo'],
  afirmacion_directa: ['lo sabés', 'ya lo sentiste', 'es así', 'la verdad es'],
  secreto: ['hay algo que', 'nadie sabe que', 'no le contás a nadie', 'el secreto'],
  verdad_incomoda: ['nadie te lo dice', 'seamos honestos', 'la realidad es'],
  contraste: ['todos ven', 'por fuera parece', 'la gente cree', 'aparentás'],
  cuerpo: ['el cuerpo habla', 'tu cuerpo sabe', 'el cansancio', 'el dolor']
};
