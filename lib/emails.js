...
// Envío de notificaciones por email usando Resend
// ═══════════════════════════════════════════════════════════════════════════════

const RESEND_API_KEY = process.env.RESEND_API_KEY;
const FROM_EMAIL = 'Duendes del Uruguay <magia@duendesdeluruguay.com>';
const REPLY_TO = 'thibisay@duendesdeluruguay.com';
...
export async function enviarEmail(to, subject, html) {
  if (!RESEND_API_KEY) {
    console.log('[EMAILS] No hay RESEND_API_KEY, email no enviado');
  ...
  try {
    ...
    if (res.ok) {
      console.log(`[EMAILS] Email enviado a ${to}: ${subject}`);
      return { success: true, id: data.id };
    } else {
      console.error(`[EMAILS] Error enviando email:`, data);
