...
export const OBJECIONES = {
  precio: {
    ...
    respuestas: [
      "Entiendo. Hay guardianes desde $70 USD, igual de especiales. ¿Querés que te muestre opciones más accesibles?",
...
export function getInstruccionesObjecion(tipo) {
  const instrucciones = {
    precio: `
      ...
      2. Ofrecer alternativas (guardianes más accesibles, desde $70 USD)
