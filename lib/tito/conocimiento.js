...
`
  ...
  tamanos: {
    mini: {
      altura: '10-15 cm',
      precioUSD: 'desde $70 USD',
      precioUY: '$2.500 - $5.500 pesos uruguayos'
    },
    mediano: {
      altura: '20-25 cm',
      precioUSD: '$150-200 USD',
      precioUY: '$8.000 - $12.500 pesos uruguayos'
    },
    grande: {
      altura: '30-40 cm',
      precioUSD: '$300-450 USD',
      precioUY: '$16.500 - $24.500 pesos uruguayos'
    },
    gigante: {
      altura: '50-70 cm',
      precioUSD: '$700-1050 USD',
      precioUY: '$39.800 - $79.800 pesos uruguayos'
    }
  },
...
// PRECIOS FIJOS URUGUAY (en pesos uruguayos) - NO se calculan, son fijos
export const PRECIOS_URUGUAY = {
  ...
  listaCompleta: `
CATEGORÍAS Y PRECIOS (pesos uruguayos):

🌿 MINI CLÁSICO - $2.500
   Guardianes tradicionales, perfectos para empezar tu conexión.
   Tamaño: 10-15cm. Ideales para espacios pequeños o para llevar de viaje.
...
DIFERENCIA CLÁSICO vs ESPECIAL vs MAESTROS MÍSTICOS:
- Clásico: Guardián tradicional, hermoso y funcional
- Especial: Más cristales, más detalles, más tiempo de creación
- Maestros Místicos: Edición premium, múltiples piedras, acabados de lujo, energía amplificada`
};
