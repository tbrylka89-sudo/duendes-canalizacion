...
export const FAQ = {
  ...
  pagos: {
    ...
    uruguay: {
      ...
      billeteras: ['Mercado Pago'],
      nota: 'Transferencia bancaria y Mercado Pago disponibles'
    },
...
- URUGUAY: Visa, MasterCard, AmEx, OCA, PassCard, Cabal, Anda, Club del Este, Redpagos, Itaú, Mercado Pago, transferencia bancaria (BROU, Bandes, BBVA, Scotiabank)
- INTERNACIONAL: Visa, MasterCard, American Express

⚠️ NO TENEMOS PAYPAL - NUNCA lo menciones como opción
✅ En Uruguay SÍ tenemos Mercado Pago
`
  },
