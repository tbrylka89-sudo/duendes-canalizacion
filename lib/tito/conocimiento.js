...
export const FAQ = {
  ...
  pagos: {
    ...
    uruguay: {
      ...
      nota: 'Transferencia bancaria disponible'
    },
...
- URUGUAY: Visa, MasterCard, AmEx, OCA, PassCard, Cabal, Anda, Club del Este, Redpagos, Itaú, transferencia bancaria (BROU, Bandes, BBVA, Scotiabank)
