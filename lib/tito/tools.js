...
export const TITO_TOOLS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    description: "Escalar la conversación al equipo humano. USAR cuando: 1) No sabés cómo responder algo, 2) El cliente tiene un problema con un pedido que no podés resolver, 3) Hay una queja o reclamo, 4) Pregunta algo muy específico que no está en tu conocimiento, 5) Pide hablar con una persona. El equipo recibirá notificación y se pondrá en contacto.",
    input_schema: {
      type: "object",
      properties: {
        motivo: {
          type: "string",
          description: "Por qué se escala: 'consulta_pedido', 'queja', 'pregunta_especifica', 'pide_humano', 'no_se_responder', 'otro'"
        },
        detalle: {
          type: "string",
        ...
        urgente: {
          type: "boolean",
          description: "Si es urgente (queja grave, cliente enojado). Default: false"
        },
        datos_cliente: {
          type: "object",
