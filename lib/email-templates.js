 ...
 *
 * Estética: Negro profundo #0a0a0a, magenta neón #ff00aa, texto blanco
...
const colors = {
  black: '#0a0a0a',
  blackLight: '#111111',
  magenta: '#ff00aa',      // Magenta neón principal
  magentaDark: '#cc0088',  // Magenta oscuro para gradientes
  magentaLight: '#ff66cc', // Magenta claro para hover
  white: '#ffffff',
...
const styles = {
  ...
  header: `
    ...
    border-bottom: 1px solid rgba(255, 0, 170, 0.2) !important;
  `,
  ...
  button: `
    ...
    background: linear-gradient(135deg, ${colors.magenta} 0%, ${colors.magentaDark} 100%) !important;
  ...
  buttonSecondary: `
    ...
    border: 2px solid ${colors.magenta} !important;
    color: ${colors.magenta} !important;
    text-decoration: none !important;
  ...
  divider: `
    ...
    background: linear-gradient(90deg, transparent, rgba(255, 0, 170, 0.3), transparent) !important;
  ...
  footer: `
    ...
    border-top: 1px solid rgba(255, 0, 170, 0.2) !important;
  `,
  ...
  guardianCard: `
    ...
    background: rgba(255, 0, 170, 0.05) !important;
    border-radius: 15px !important;
    border: 1px solid rgba(255, 0, 170, 0.2) !important;
  `,
  ...
  guardianImageContainer: `
    ...
    border: 4px solid ${colors.magenta} !important;
    box-shadow: 0 0 30px rgba(255, 0, 170, 0.3) !important;
  `,
  ...
  detailsRow: `
    border-bottom: 1px solid rgba(255, 0, 170, 0.15) !important;
  `,
  ...
  discountCode: `
    ...
    letter-spacing: 3px !important;
    border: 2px dashed ${colors.magenta} !important;
  ...
  const content = `
    <div style="${styles.body}">
      ...
      <p style="${styles.textCenter}">
        <strong style="color: ${colors.magenta} !important;">Paso importante:</strong><br>
...
export function emailBienvenidaMiMagia({
  ...
  const content = `
    <div style="${styles.body}">
      ...
      <p style="${styles.text}">
        ${nombreCliente}, ahora tenés acceso a <strong style="color: ${colors.magenta} !important;">Mi Magia</strong>,
...
export function emailBienvenidaCirculo({
  ...
  const content = `
    <div style="${styles.body}">
      ...
      <p style="${styles.textCenter}">
        <strong style="color: ${colors.magenta} !important;">Tus beneficios:</strong>
      </p>
...
export function emailTest({ nombre }) {
  const content = `
    <div style="${styles.body}">
      ...
      <div style="${styles.highlight}">
        <p style="${styles.highlightText}">
          Si estás viendo esto con todos los estilos correctos
          (fondo negro, texto blanco, acentos dorados),
          el sistema funciona perfectamente.
        </p>
      </div>

      ${discountCodeBox('TEST2026', 'Código de prueba')}
  ...
  `;
  return baseTemplate(content, { preheader: 'Email de prueba - Sistema Duendes del Uruguay' });
}
