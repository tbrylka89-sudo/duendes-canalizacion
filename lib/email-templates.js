...
<body style="margin: 0 !important; padding: 0 !important; background-color: #000000 !important; -webkit-text-size-adjust: 100% !important;">
  <div style="${styles.container}" class="dark-mode">
    ...
    <div style="${styles.header}">
      <div style="width: 60px !important; height: 1px !important; background: linear-gradient(90deg, transparent, ${colors.gold}, transparent) !important; margin: 0 auto 20px !important;"></div>
      <h1 style="${styles.logo}">Duendes del Uruguay</h1>
      <div style="width: 60px !important; height: 1px !important; background: linear-gradient(90deg, transparent, ${colors.gold}, transparent) !important; margin: 20px auto 0 !important;"></div>
    </div>
    ${content}
