...
// Cuando 10Web arregle el SSL, cambiar a: 'https://duendesdeluruguay.com'
export const WORDPRESS_URL = process.env.WORDPRESS_URL || 'https://duendesuy.10web.cloud';
...
// Paquetes de runas con metadata
export const RUNAS_PACKS = [
  { nombre: 'Chispa', runas: 50, precio: 7, url: RUNAS_URLS.chispa, desc: 'Para empezar a explorar' },
  { nombre: 'Destello', runas: 100, precio: 12, url: RUNAS_URLS.destello, desc: 'El más popular' },
  { nombre: 'Fulgor', runas: 200, precio: 18, url: RUNAS_URLS.fulgor, desc: 'Para varias experiencias' },
  { nombre: 'Resplandor', runas: 350, precio: 32, url: RUNAS_URLS.resplandor, desc: 'El mejor valor' },
];
